...
export default function ViewResultsPage() {
  ...
  const fallBackContactId = 'abc123def456';
  ...
  // SEO: prevent indexing shared results
  const pageDescription =
    'View your BALL homeownership readiness game results and personalized insights.';

  if (loading || contact_id === fallBackContactId) {
    return (
      <>
        <SeoHead
          title="Viewing Game Result"
    ...
    return (
      <>
        <SeoHead
          ...
          description="The result you are trying to view could not be located."
          noIndex={true}
        />
