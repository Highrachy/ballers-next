...
export const TIERS = [
  /* ─────────────────── 1. CERTIFIED BALLER ─────────────────── */
  {
    ...
    descriptions: [
      ...
      /* 3 */ 'Cash flexing harder than bouncer;\n house keys lining up for autograph.',
      ...
      /* 6 */ 'Money muscles pumped;\n you fit carry a whole estate with one hand.',
      /* 7 */ 'Property market dey rush you;\n just open your gate and collect your key.',
      /* 8 */ 'Baller shine brighter than security torch\n every plot dey salute you.',
    ...
    summaries: {
      rent: [
        ...
        /* 2 */ 'Those rent receipts are taller than you—swap them for a land deed. Lock a <house_type> fast and let future-you send high-five emojis. Keys can land <timeline_phrase> if you keep stacking coins. Landlord selfie incoming!',
        ...
        /* 4 */ "No more “God when,” it's “God now!” Keys loading like cartoon power-up. Jollof pot already warming in <location_zone>. Pack your things and practise the happy dance.",
      ...
      family: [
        /* 0 */ 'Free jollof sweet, but your own kitchen aroma sweeter. A <bedroom> <house_type> on the <location_zone> hides just beyond the gate. Keep saving and meal times become home times <timeline_phrase>. Your first pot of stew will smell like victory.',
  ...
  /* ─────────────────── 2. ALMOST THERE ────────────────────── */
  {
    ...
    descriptions: [
      /* 0 */ 'Ice-cream truck of homeownership is close—just one more street to cross.',
      /* 1 */ 'Your savings balloon is big;\n One tiny breath and it pops into keys.',
      /* 2 */ 'House keys waving like teacher in class—raise your hand and grab them.',
      /* 3 */ 'Little hustle left, then the gate will swing open just for you.',
      /* 4 */ 'Small spark left;\n when it lights, your own house fire will glow bright.',
      /* 5 */ 'Pocket puff-puff rising—keep the heat and it turns into a front door.',
      /* 6 */ 'Money marathon reached last bend;\n Sprint a little and win the medal.',
      /* 7 */ 'Doorbell almost shouting your name—walk faster and press it yourself.',
      /* 8 */ 'Savings soup is thick;\n one more stir and it will serve in your kitchen.',
      /* 9 */ 'Tiny push, loud boom—keys are hiding right behind the corner.',
    ],
  ...
  /* ─────────────────── 3. GETTING STARTED (index-aligned) ─────────────────── */
  {
    ...
    descriptions: [
      /* 0 */ 'Baby steps today, giant footprints tomorrow.',
      /* 1 */ 'Your keke-savings is moving, e dey go slow, but he go reach there one day.',
      /* 2 */ 'Pure-water drops can fill an ocean of bricks.',
      /* 3 */ "Big dream engine is on;\n Don't press brake.",
      /* 4 */ 'Tiny brick now, tall castle later.',
      /* 5 */ 'Piggy-bank just went boom, money dey everywhere!',
      /* 6 */ 'Wallet learning to crawl before it runs.',
      /* 7 */ 'Every naira is a seed,\n plant all of naira now.',
      /* 8 */ 'Savings sprouts are peeping through the soil.',
      /* 9 */ 'Battery charging;\n percent climbing steady-steady.',
    ],
    ...
    summaries: {
      ...
      rent: [
        ...
        /* 5 */ 'Your piggy-bank just went boom, money dey everywhere! Sweep them into a deposit for a <bedroom> <house_type> in <location_zone>. Keep adding and the pig will oink out keys <timeline_phrase>. Best explosion ever!',
      ...
      own: [
        ...
        /* 5 */ 'Piggy-bank fireworks can light up new profit rooms. Gather the glittering coins and fire them at a second property. A sparkling <bedroom> <house_type> on the <location_zone> answers back. Double boom, double income!',
      ...
      family: [
        ...
        /* 5 */ "Bang! Your piggy-bank don shatter. Scoop the treasure into a house jar. Target a cute <bedroom> <house_type> on the <location_zone>. Move day will feel like New Year's fireworks in your belly.",
  ...
  /* ─────────────────── 4. BOOST EARNINGS (index-aligned) ─────────────────── */
  {
    ...
    /* descriptions[ i ] ↔ summaries.*[ i ]  (10 each) */
    descriptions: [
      /* 0 */ 'House still far, but you fit get them if you fit make extra money.',
      /* 1 */ 'Your wallet slim like broom;\n add hustles to make it fat.',
      /* 2 */ 'Side-gig is the engine oil;\n if oil no dey, engine go knock.',
      /* 3 */ 'Party rice sweet, but savings stew even sweeter.',
      /* 4 */ 'Dream house dey jog;\n boost earnings so you can sprint.',
      /* 5 */ 'Free rent is cheat code—use it to level up cash.',
      /* 6 */ 'Make your phone a mini-office;\n let it guide you toward making more money.',
      /* 7 */ 'Bad debt drags like traffic;\n clear lane, then zoom.',
      /* 8 */ 'Small plot first, mansion later. Plant your seed now.',
      /* 9 */ 'Every “awoof” alert belongs in the land kitty, not sneakers.',
    ],
    ...
    summaries: {
      ...
      rent: [
        ...
        /* 3 */ "Party rice tastes good but disappears fast. Cook savings stew instead—it stays hot. Skip two parties and you're closer to buying a <bedroom> <house_type> on the <location_zone>. Your tummy and wallet will both cheer!",
        ...
        /* 9 */ 'Every “Awoof” alert should jump into your kitty, not your sneakers. When the kitty is fat it buys land, not laces. Keep feeding it and a shiny <bedroom> <house_type> in <location_zone> appears. Fashion fades, property stays fresh forever.',
      ],
      ...
      own: [
        ...
        /* 2 */ 'Side gigs are oil even for landlords. Host workshops, sell e-books, or flip thrift items. All profits turbo-charge your down-payment. Soon House C—another <bedroom> <house_type> on the <location_zone>—parks in your name.',
      ...
      family: [
        ...
        /* 9 */ "Awoof alerts love sneakers, but sneakers don't build rooms. Park the alerts in your land kitty instead. Soon a cozy <bedroom> <house_type> in <location_zone> pops out. Fashion fades—property stays fly forever.",
      ],
    },
  },
];
