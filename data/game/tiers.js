...
export const TIERS = [
  ...
  /* ─────────────────── 2. ALMOST THERE ────────────────────── */
  {
    ...
    descriptions: [
      ...
      /* 4 */ 'Small spark left; when it lights, your own house fire will glow bright.',
      /* 5 */ 'Pocket puff-puff rising—keep the heat and it turns into a front door.',
      /* 6 */ 'Money marathon reached last bend; Sprint a little and win the medal.',
      /* 7 */ 'Doorbell almost shouting your name—walk faster and press it yourself.',
      /* 8 */ 'Savings soup is thick; one more stir and it will serve in your kitchen.',
  ...
  /* ─────────────────── 3. GETTING STARTED (index-aligned) ─────────────────── */
  {
    ...
    descriptions: [
      ...
      /* 1 */ 'Your keke-savings is moving on a slow pace, e go reach there one day.',
      /* 2 */ 'Pure-water drops can fill an ocean of bricks.',
      /* 3 */ "Big dream engine is on; Don't press brake.",
      /* 4 */ 'Tiny brick now, tall building later.',
      /* 5 */ 'If your piggy bank explode, money dey everywhere!',
      /* 6 */ 'Wallet learning to crawl before it runs.',
      /* 7 */ 'Every naira is a seed, plant all of naira now.',
      /* 8 */ 'Savings sprouts are peeping through the soil.',
      /* 9 */ 'Battery charging; percent climbing steady-steady.',
    ],
  ...
  /* ─────────────────── 4. BOOST EARNINGS (index-aligned) ─────────────────── */
  {
    ...
    descriptions: [
      ...
      /* 1 */ 'Your wallet slim like broom; add hustles to make it fat.',
      /* 2 */ 'Side-gig is the engine oil; if oil no dey, engine go knock.',
      /* 3 */ 'Party rice sweet, but savings stew even sweeter.',
      /* 4 */ 'Dream house dey jog; boost earnings so you can sprint.',
      /* 5 */ 'Free rent is cheat code—use it to level up cash.',
      /* 6 */ 'Make your phone a mini-office; let it guide you toward making more money.',
      /* 7 */ 'Bad debt drags like traffic; clear lane, then zoom.',
